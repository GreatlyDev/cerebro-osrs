...
async def create_goal(
    ...
    return await goal_service.create_goal(db_session=db_session, payload=payload)
...
async def list_goals(
    ...
    return await goal_service.list_goals(db_session=db_session)
...
async def generate_goal_plan(
    ...
    return await goal_service.generate_plan(db_session=db_session, goal_id=goal_id)
